...
from config import MIN_CLIMBER_CONF
climberYoloModel = YOLO(r"C:\Users\adith\Documents\Projects\python-projects\Rakshak-2.0\trained_models\climber.pt").to(torch.device(current_device))
...
def detect_climber(frame):
    ...
    return parse_yolo_predictions(outputs,MIN_CLIMBER_CONF)
