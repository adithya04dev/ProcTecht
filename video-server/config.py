...
MIN_TAMPER_CONF = 0.55
MIN_CRACK_CONF = 0.72
MIN_FIRE_CONF = 0.40
MIN_ACCIDENT_CONF = 0.5
MIN_VIOLENCE_CONF = 0.5
MIN_WEAPON_CONF = 0.45
MIN_CLIMBER_CONF=0.2

MIN_CRACK_REPORT_CONF = 0.4
MIN_ACCIDENT_REPORT_CONF = 0.3
MIN_FIRE_REPORT_CONF = 0.40
MIN_VIOLENCE_REPORT_CONF = 0.5
MIN_WEAPON_REPORT_CONF = 0.45
